        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    >
                        ...
                        <p class="mt-2 text-gray-600 dark:text-gray-400">
                            @if(auth()->user()->hasRole('Verifikator'))
                                Selamat bekerja dan memverifikasi laporan tim Anda hari ini.
                            @elseif(auth()->user()->hasRole('Human Resource'))
                                Semoga harimu produktif dalam mereviewing dan mengelola laporan tim.
                    ...
                    <!-- Role-specific dashboard section from view composer -->
                    @if(isset($roleSection))
                        @if($roleSection === 'verifikator')
                            @includeIf("dashboard.sections._$roleSection")
                        @else
                            @includeIf("dashboard.sections._$roleSection", [
                                'pendingVerificationCount' => $pendingVerificationCount ?? 0, 
                                'hasReportToday' => $hasReportToday ?? false,
                        ...
                        @endif
                    @else
                        <!-- Fallback untuk role tanpa specific dashboard -->
                        @php
                        ...
                        @unless(auth()->user()->hasRole('Vice President'))
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                            @unless(auth()->user()->hasRole(['Verifikator', 'Vice President']))
                        ...
                        @if(auth()->user()->isAdmin() && isset($usersWithoutReport) && count($usersWithoutReport) > 0 && !auth()->user()->hasRole('Verifikator'))
                        ...
                        <!-- Recent Reports (tidak tampil untuk Verifikator dan VP) -->
                        @unless(auth()->user()->hasRole(['Verifikator', 'Vice President']))
                            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                                <div class="p-6">
